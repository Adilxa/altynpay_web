                    ...
                    <div className={s.cards}>
                        <div className={s.blockTop}>
                            <div className={s.firstCard}>
                                ...
                                <Image style={{bottom: "-10px"}} src={coin} alt="photo" className={s.coin}/>
                            </div>

                            <div className={s.secondCard} style={{position: "relative", overflow: "hidden"}}>
                                <div className={s.text}>
                                ...
                                <div className={s.coin}>
                                    <Image style={{bottom: "10px", position: "absolute"}} src={rocket} alt="photo"/>
                                </div>
                            </div>
                            ...
                            <div className={s.thirdCard}>
                                ...
                                <Image style={{bottom: "-10px"}} src={computer} alt="photo" className={s.coin}/>
                            </div>
                        </div>
